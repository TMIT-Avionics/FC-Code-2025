  ...
  //
  // MS5611_SPI MS5611( 5, 23, 19, 18);   // ESP32 SW SPI  //VSPI
  // MS5611_SPI MS5611(15, 13, 12, 14);   // ESP32 SW SPI  //HSPI
  // MS5611_SPI MS5611(12, 13, 15, 14); // use if using non burned ESP
  //  MS5611_SPI MS5611(15, 13, 27, 14); // use if using LTS Iris board config
  // (CS, MOSI, MISO, CLK) is the constructor
  //
  ...
  */
  ...
  void test()
  {
    ...
    else
    {
      ...
      Serial.print("\tP:\t");
      Serial.print(MS5611.getPressure()*(-1), 2);
      Serial.print("\tt:\t");
