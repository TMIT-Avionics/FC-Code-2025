...
@date 01-04-2025 | @author thrustMIT 2024-25 */
...
TwoWire I2C_GNSS = TwoWire(1); //for GNSS
/* VARIABLES
...
void setup() {
  ...
  if(myGNSS.begin(myWire, GNSS_ADDRESS) == false)
  {
